...
class MultiByteChar implements Stream
{
    ...
    public function seek(int $offset): void
    {
        ...
        $part = mb_substr($this->contents, 0, $offset);
        $newlines = mb_substr_count($part, "\n");
        ...
        if ($newlines > 0) {
            ...
            $this->column = $offset - mb_strripos($part, "\n") - 1;
        }
    ...
    public function consume(): Slice
    {
        ...
        return new Slice($this, $this->offset, 1);
    }
